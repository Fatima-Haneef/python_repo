...
df = pd.read_csv('python_repo/week6/assignments/Real_Estate_Sales_2001-2022_GL-Short.csv' , index_col="Serial Number")
...
# Predict for 3 sample values
sample_values = [50000, 120000, 200000]
