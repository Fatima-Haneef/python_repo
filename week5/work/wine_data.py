...
# """
# accuracy = classification_report(y_test, log_reg_preds, output_dict=True)["accuracy"]
...
my_wine_data = load_wine()
my_wine_data_return_X_y = load_wine(return_X_y=True)
# print(my_wine_data_return_X_y)
print(my_wine_data_return_X_y[0])
print(my_wine_data_return_X_y[1])

my_wine_data_as_frame = load_wine(as_frame=True)
print(my_wine_data_as_frame)

wine_pandas_df = pd.DataFrame(my_wine_data.data,columns=my_wine_data.feature_names)
print(wine_pandas_df)


print(wine_pandas_df.head())
print(wine_pandas_df.info())
print(wine_pandas_df.describe())
print(wine_pandas_df.tail())


from sklearn.preprocessing import StandardScaler
X= wine_pandas_df[my_wine_data.feature_names].copy()
# y = wine_pandas_df['target'].copy()
